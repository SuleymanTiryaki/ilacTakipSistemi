...
class AddPillWidget extends StatefulWidget {
  ...
  const AddPillWidget({super.key, this.onTap, required this.textController, required this.textController2, required this.textController3, required this.dropdownvalue, required this.timeOfDayValue});
...
final List<String> _items = ["ml","mg","hap",];
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          MaterialButton(onPressed: _showTimePicker,child:
      ...
      ValueListenableBuilder(
          ...
          builder: (context, timeValueValue, _) {
           return Text(timeValueValue.format(context).toString(),
              style: TextStyle(fontSize: 15),);
          ...
          //KAYDET BUTONU
          MaterialButton(onPressed: widget.onTap ,child: Text("Kaydet",
            style: TextStyle(fontSize: 15),)
            ,color:(Colors.white),)
        ],
